...
$repos = "animator-css", "animator-velocity", "app-contacts", "app-ux-showcase", "aurelia", "benchmarks", "binding", "bootstrapper", "bootstrapper-webpack", "bundler", "cache", "cli", "dependency-injection", "dialog", "documentation", "event-aggregator", "fetch-client", "framework", "history", "history-browser", "html-import-template-loader", "html-template-element", "http-client", "i18n", "loader", "loader-default", "loader-webpack", "logging", "logging-console", "metadata", "pal", "pal-browser", "pal-nodejs", "pal-worker", "path", "polyfills", "protractor-plugin", "registry", "route-recognizer", "router", "skeleton-navigation", "skeleton-plugin", "skeleton-server-render", "task-queue", "templating", "templating-binding", "templating-resources", "templating-router", "testing", "tools", "typings", "ui-virtualization", "ux", "validatejs", "validation", "vscode-extension", "web-components", "webpack-plugin"
